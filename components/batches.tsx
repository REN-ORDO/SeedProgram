...
function ProximamenteBanner() {
  return (
    <div
      aria-hidden
      className="pointer-events-none absolute right-3 top-5 z-20 rotate-[10deg] whitespace-nowrap border-2 border-[--color-ink] bg-white px-3 py-1.5 font-display text-[11px] font-extrabold uppercase tracking-widest text-[--color-ink] shadow-[3px_3px_0_var(--color-ink)]"
    >
      Próximamente
    </div>
  );
