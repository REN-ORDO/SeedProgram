...
export const testimonios: Testimonio[] = [
  ...
  },
  {
    ...
    body: "Antes de entrar al Batch estaba en capacitación para un call center de soporte técnico. No era porque me gustara, simplemente era algo que sabía hacer y necesitaba el dinero. Las condiciones no eran fáciles: horarios exigentes, métricas constantes y muy poco espacio para uno mismo. Aunque estaba estudiando para ser un Ingeniero de Sistemas, lo veía como algo lejano; muchas puertas se habían cerrado y había dejado de insistir, confiando en que el tiempo de Dios era perfecto. Me enteré del Batch gracias a un amigo que me animó a buscar información y aplicar. Entré incluso tarde, después de tomar una decisión difícil: renunciar a la capacitación y al pago de los días que ya había trabajado para apostar por una oportunidad incierta. Desde los primeros días sentí que era un lugar diferente porque estaba rodeado de personas con objetivos y motivaciones parecidas a las mías; cada uno tenía su historia, pero todos compartíamos las ganas de crecer. Uno de los retos que más me marcó fue integrar un chatbot con n8n. Aunque tenía buenas bases como ingeniero, muchas de las herramientas más recientes eran completamente nuevas para mí. Me sentí perdido al principio, como si me hubieran lanzado al punto mar, solo sabiendo nadar y nada a tu alrededor. Pero seguí aprendiendo sin rendirme hasta sacarlo adelante. También recuerdo las reuniones en Discord, donde siempre había alguien dispuesto a ayudarte a entender mejor las cosas. Con el tiempo me di cuenta de que estaba cambiando cuando empecé a organizar mis días de otra manera y descubrí que me gustaba madrugar y tener autonomía sobre mi tiempo. Al terminar el Batch y quedar en una buena posición, comenzaron a asignarme proyectos poco a poco, convirtiéndose en el puente hacia mi carrera profesional. Hoy trabajo como desarrollador junior, disfruto aprender de todo un poco y veo al Andrés de aquella capacitación como alguien que estaba atrapado sin darse cuenta. Ahora intento tomar decisiones pensando también en mi familia y en la vida que quiero construir.",
